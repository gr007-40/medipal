    ...
    return (
        <div>
            <Box className={styles.page} display={'flex'} flexDirection={'column'}>
                <Image alt={''} src="/hp.png" className={classes.hero}/>
                    ...
                    <Grid container spacing={3}>
                        ...
                        <Grid item xs={12} sm={6} md={4}>
                            <Box sx={{display: 'flex', justifyContent: 'center', t: 10}}>
                                <Box sx={{...commonStyles, border: 0, backgroundColor: '#AEC6CF',}}>
                                    <Image alt='' src="/E.jpg" width="100%" height="62%"/>
                        ...
                        <Grid item xs={12} sm={6} md={4}>
                            <Box sx={{display: 'flex', justifyContent: 'center'}}>
                                ...
                                <Box sx={{...commonStyles, border: 0, backgroundColor: '#AEC6CF',}}>
                                    <Image alt={''} src="/m.jpg" width="100%" height="62%"/>
                                    <Typography variant={'h6'} align={'center'}
                                                sx={{color: '#000080', fontFamily: 'Raleway'}} paragraph gutterBottom>OUR
                                        MISSION </Typography>
                                    <Typography variant={'h6'} align={'center'}
                        ...
                        <Grid item xs={12} sm={6} md={4}>
                            <Box sx={{display: 'flex', justifyContent: 'center'}}>
                                ...
                                <Box sx={{...commonStyles, border: 0, backgroundColor: '#AEC6CF',}}>
                                    <Image alt='' src="/pi.jpg" width="100%" height="62%"/>
                                    <Typography variant={'h6'} align={'center'}
