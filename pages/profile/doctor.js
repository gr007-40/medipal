...
export default function Doctor(){
    const id = postData('/api/verify',{}).then((session)=>{
        if(session.isVerified){
            return session.id;
        }
    })
    // const doctor = postData('/api/doctor').then((doctor)=>{return doctor});
    const doctor = {
        id: 12,
    ...
    const columns = [
        { field: 'id', headerName: 'Day', sortable: false, width: 100 , editable: false},
        {
            field: 'hospital',
            headerName: 'Hospital',
            sortable: false,
        ...
        { field: 'from', headerName: 'From', sortable: false, width: 80, editable: true },
        { field: 'to', headerName: 'To', sortable: false, width: 80, editable: true },
    ];
